...
def pad_body(msgtotalsize, body):
    """ Unpad the sphinxmix message body."""
    body = body + b"\x7f"
...
def create_header(params, nodelist, keys, dest, assoc=None):
    """ Internal function, creating a sphinxmix header."""
...
def create_surb(params, nodelist, keys, dest, assoc=None):
    """Creates a sphinxmix single use reply block (SURB) using a set of parameters;
