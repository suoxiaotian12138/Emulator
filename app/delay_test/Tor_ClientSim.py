# examples/Tor_simplified/Tor_ClientSim.py
from examples.Tor_simplified.Tor_Client import Tor_Client as _Tor_Client_Base
from app.delay_test.Tor_SocketSim import Tor_SocketSim
